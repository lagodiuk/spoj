...
public class NAJKRACI_10_Dijkstra_Dynamic_Programming {
	...
	static int[] solve(int verticesCnt, Edge_2[] edges) {
		...
		for (int i = 0; i < verticesCnt; i++) {
			...
			// System.out.printf("dist from %d to %d is %d\n", i, j, vtxs[j].dist);
			// }
			//
			// System.out.println();
			// for (int j = 0; j < verticesCnt; j++) {
			// System.out.printf("ingoing from %d to %d is %d\n", i, j, vtxs[j].ingoing_cnt);
			// }
			//
			// System.out.println();
			// for (int j = 0; j < verticesCnt; j++) {
			// System.out.printf("outgoing from %d to %d is %d\n", i, j, vtxs[j].outgoing_cnt);
			// }
		}
