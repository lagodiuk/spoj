...
public class FCANDY_4_Top_Down {

	public static void main(String[] args) {
		FCANDY_1_Top_Down.evaluateExample(FCANDY_4_Top_Down::solve);
		FCANDY_1_Top_Down.evaluateRandomized(FCANDY_4_Top_Down::solve, true, 6);
	}
	...
	static int solve(Candies[] candies) {
		...
		int result = totalCalories - solve(0, 0, candies, totalCalories);
		return result;
	}
