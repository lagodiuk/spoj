...
public class FCANDY_2_Top_Down {

	public static void main(String[] args) {
		FCANDY_1_Top_Down.evaluateExample(FCANDY_2_Top_Down::solve);
		FCANDY_1_Top_Down.evaluateRandomized(FCANDY_2_Top_Down::solve, true, 6);
	}
	...
	static int solve(int bag1, int i, Candies[] candies, int totalCalories) {
		...
		if (i >= candies.length) {
			return Math.abs(totalCalories - (2 * bag1));
		}
