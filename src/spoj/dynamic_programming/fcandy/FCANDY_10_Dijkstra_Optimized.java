...
public class FCANDY_10_Dijkstra_Optimized {
	...
	public static void main(String[] args) {
		...
		FCANDY_1_Top_Down.evaluateExample(FCANDY_10_Dijkstra_Optimized::solve1);
		FCANDY_1_Top_Down.evaluateRandomized(FCANDY_10_Dijkstra_Optimized::solve1, true, 6);
		FCANDY_1_Top_Down.evaluateRandomized(FCANDY_10_Dijkstra_Optimized::solve1, false, MAX_I, MAX_COUNT, MAX_CALORIES);
