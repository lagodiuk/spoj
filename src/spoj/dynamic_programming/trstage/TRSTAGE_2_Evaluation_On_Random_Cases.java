...
public class TRSTAGE_2_Evaluation_On_Random_Cases {
	...
	private static void measurePerformance_SimpleCases() {
		long startTime = System.currentTimeMillis();
		for (int i = 0; i < 100; i++) {
		...
		System.out.println("Total time: " + ((System.currentTimeMillis() - startTime) / 1000.0) + " sec");
	}
