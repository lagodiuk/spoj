...
public class MMINPAID_2 {

	public static void main(String[] args) {
		MMINPAID_1.exampleFromDescriptionOfProblem(MMINPAID_2::solve);
		MMINPAID_1.testRandomized1(MMINPAID_2::solve);
		MMINPAID_1.testRandomized2(MMINPAID_2::solve);
	}
