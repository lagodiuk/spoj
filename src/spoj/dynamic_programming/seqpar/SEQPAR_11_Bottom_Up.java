...
public class SEQPAR_11_Bottom_Up {

	public static void main(String[] args) {
		SEQPAR_BruteForce.testFewManualCases(SEQPAR_11_Bottom_Up::solve);
		SEQPAR_BruteForce.testRandomized(SEQPAR_11_Bottom_Up::solve);
	}
