...
public class IKEYB_3_DP_Bottom_Up {

	public static void main(String[] args) {
		IKEYB_Brute_Force.verifySpecificTestCases(IKEYB_3_DP_Bottom_Up::solve);
		IKEYB_Brute_Force.verifyRandomTestCases(IKEYB_3_DP_Bottom_Up::solve);
	}
	...
	static long[][] mem = new long[91][91];
