...
public class MINUS_9 {

	public static void main(String[] args) {
		MINUS_Testing.testFewManualCases(MINUS_9::solve);
		MINUS_Testing.testRandomized(MINUS_9::solve);
	}
	...
	static int solve(int col, int target, int[][] partDiff, int[][] mem) {
		...
		for (int r = col; r < partDiff.length; r++) {
			if (solve(r + 1, partDiff[col][r] - target, partDiff, mem) == TRUE) {
