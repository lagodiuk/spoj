...
public class MTRIAREA_4_Convex_Hull_Triangulation_Bottom_Up {

	public static void main(String[] args) {
		// MTRIAREA_1_Brute_Force.test(MTRIAREA_3_Convex_Hull_Brute_Force::solve);
		MTRIAREA_1_Brute_Force.test(MTRIAREA_4_Convex_Hull_Triangulation_Bottom_Up::solve, true, 50, true);
		// MTRIAREA_1_Brute_Force.test(MTRIAREA_4_Convex_Hull_Triangulation_Bottom_Up::solve, false,
		// 50000,false);
	}
	...
	public static double solve(Point[] points) {
		...
		double[][] mem = triangulation_bottom_up(points);
		double result = mem[0][points.length - 1];
		print_memoization_table(mem);
		return result;
	}

	private static double[][] triangulation_bottom_up(Point[] points) {
