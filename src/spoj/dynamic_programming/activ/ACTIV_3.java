...
public class ACTIV_3 {

	public static void main(String[] args) {
		ACTIV_Brute_Force.testFewManualCases(ACTIV_3::solve);
		ACTIV_Brute_Force.testRandomizedCases(ACTIV_3::solve);
		ACTIV_Brute_Force.testRandomizedCases(ACTIV_3::solve, 20, true);
		ACTIV_Brute_Force.testRandomizedCases(ACTIV_3::solve, 1000, false);
	}
